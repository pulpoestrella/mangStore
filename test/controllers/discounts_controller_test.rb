...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference("Discount.count") do
      post discounts_url, params: { discount: { active: @discount.active, name: @discount.name, percent: @discount.percent } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { active: @discount.active, name: @discount.name, percent: @discount.percent } }
